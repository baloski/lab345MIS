...
import 'package:lab345mis/Models/user.dart';
import 'package:lab345mis/Pages/authentication.dart';
import 'package:lab345mis/Pages/calendar_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    _userItemsList = [
      User(id: "U1", username: "user", password: "user", listItems: [
        ListItem(
          id: "S1",
          subject: "MIS",
  ...
  void _deleteItem(String id) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text("Subject deleted from the calendar"),
